...
#include "tensorflow/tsl/platform/google/dynamic_annotations.h"  // IWYU pragma: export
...
#include "tensorflow/tsl/platform/default/dynamic_annotations.h"  // IWYU pragma: export
#else
