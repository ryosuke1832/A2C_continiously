...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_RESHAPE_DECOMPOSER_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_RESHAPE_DECOMPOSER_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_RESHAPE_DECOMPOSER_H_
