...
#ifndef TENSORFLOW_COMPILER_XLA_HLO_IR_HLO_MODULE_METADATA_H_
#define TENSORFLOW_COMPILER_XLA_HLO_IR_HLO_MODULE_METADATA_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_HLO_IR_HLO_MODULE_METADATA_H_
