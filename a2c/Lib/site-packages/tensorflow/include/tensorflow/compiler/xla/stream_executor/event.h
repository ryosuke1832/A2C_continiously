...
#ifndef TENSORFLOW_COMPILER_XLA_STREAM_EXECUTOR_EVENT_H_
#define TENSORFLOW_COMPILER_XLA_STREAM_EXECUTOR_EVENT_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_STREAM_EXECUTOR_EVENT_H_
